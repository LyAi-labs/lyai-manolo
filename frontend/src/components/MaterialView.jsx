    ...
    <div className="space-y-2">
      {material.resumen && (
        <div className="rounded-xl bg-white ring-1 ring-slate-100 p-3">
          <div className="text-[10px] font-bold text-slate-400">{t('material.summary')}</div>
      ...
      {Array.isArray(material.ejercicios) && material.ejercicios.length > 0 && (
        <div className="rounded-xl bg-white ring-1 ring-slate-100 p-3">
          <div className="text-[10px] font-bold text-slate-400">{t('material.exercises')}</div>
      ...
      {Array.isArray(material.flashcards) && material.flashcards.length > 0 && (
        <div className="rounded-xl bg-white ring-1 ring-slate-100 p-3">
          <div className="text-[10px] font-bold text-slate-400">{t('material.flashcards')}</div>
      ...
      {material.deberes && (
        <div className="rounded-xl bg-brand-50 ring-1 ring-brand-100 p-3">
          <div className="text-[10px] font-bold text-brand-600">{t('material.homework')}</div>
